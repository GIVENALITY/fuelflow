            ...
            <ul class="navbar-nav justify-content-end align-items-center">
                <li class="nav-item d-flex align-items-center">
                    <a href="{{ route('profile.index') }}"
                        class="nav-link text-body font-weight-bold px-2 d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    <a href="{{ route('notifications.index') }}"
                        class="nav-link text-body p-0 d-flex align-items-center position-relative"
                        id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="material-symbols-rounded cursor-pointer" style="font-size: 20px;">notifications</i>
                        @php
                        ...
                        @if($unreadCount > 0)
                            <span
                                ...
                                style="font-size: 9px; min-width: 16px; height: 16px; line-height: 16px; padding: 0 4px; z-index: 1000;">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0">
                                            <i class="material-symbols-rounded me-1"
                                                style="font-size: 12px;">schedule</i>
                                            13 minutes ago
                                        </p>
                                    </div>
                                </div>
