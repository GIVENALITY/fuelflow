                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Price (TZS)</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Effective Date</th>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">{{ $fuelPrice->station->name }}</h6>
                                                <p class="text-xs text-secondary mb-0">{{ $fuelPrice->station->location }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge badge-sm bg-gradient-{{ $fuelPrice->fuel_type === 'petrol' ? 'warning' : 'info' }}">
                                            {{ ucfirst($fuelPrice->fuel_type) }}
                                        </span>
                                    </td>
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">{{ number_format($fuelPrice->price, 2) }} TZS</p>
                                    </td>
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">{{ $fuelPrice->effective_date->format('M d, Y') }}</p>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-4">
                                        <p class="text-sm text-secondary mb-0">No fuel prices found.</p>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
