                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <div class="row">
                                <div class="col-6">
                                    <h6 class="text-white text-capitalize ps-3">Create New Fuel Price</h6>
                                </div>
                    ...
                    <div class="card-body px-4 pb-2">
                        <form method="POST" action="{{ route('fuel-prices.store') }}">
                            @csrf

                            <div class="row">
                                <div class="col-md-6">
                                    <div
                                        class="input-group input-group-outline {{ old('station_id') ? 'is-filled' : '' }} my-3">
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="input-group input-group-outline {{ old('fuel_type') ? 'is-filled' : '' }} my-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group input-group-outline {{ old('price') ? 'is-filled' : '' }} my-3">
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="input-group input-group-outline {{ old('effective_date') ? 'is-filled' : '' }} my-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-group input-group-outline {{ old('notes') ? 'is-filled' : '' }} my-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="material-symbols-rounded">save</i> Create Fuel Price
                                    </button>
