...
@section('title', 'Station Attendant Dashboard')
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1">Station Attendant Dashboard</h4>
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Assigned Requests</p>
                            <h4 class="mb-0">{{ $assignedRequests ?? 0 }}</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                        <p class="mb-0"><span class="text-info text-sm font-weight-bolder">Active</span> assignments</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Completed Today</p>
                            <h4 class="mb-0">{{ $completedToday ?? 0 }}</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                        <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+3</span> from yesterday</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Fuel Dispensed</p>
                            <h4 class="mb-0">{{ number_format($fuelDispensed ?? 0) }}L</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                        <p class="mb-0"><span class="text-warning text-sm font-weight-bolder">Today's</span> total</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Pending Tasks</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-7">
                                ...
                                <p class="text-sm mb-0">
                                    ...
                                    <span class="font-weight-bold ms-1">Your assignments</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    @forelse($assignedRequestsList ?? [] as $request)
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-4">
                                            <p class="text-sm text-secondary mb-0">No assigned requests found</p>
                                        </td>
                                    </tr>
                                    @endforelse
                                </tbody>
                    ...
                    <div class="card-body p-3">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('station-attendant.vehicles.search') }}" class="btn btn-outline-primary btn-sm">
                                <i class="material-symbols-rounded me-2">search</i>Search Vehicle
                            </a>
                            <a href="{{ route('station-attendant.dashboard') }}" class="btn btn-outline-success btn-sm">
                                <i class="material-symbols-rounded me-2">dashboard</i>My Dashboard
                            </a>
                        </div>
                    </div>
                </div>
