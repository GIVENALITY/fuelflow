        ...
        <div class="row mb-4">
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">TSh {{ number_format($totalRevenue ?? 0) }}</h4>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    ...
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                        <p class="mb-0"><span class="text-info text-sm font-weight-bolder">+3</span> new this month</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">{{ $totalStations ?? 0 }}</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                        <p class="mb-0"><span class="text-warning text-sm font-weight-bolder">All</span> operational</p>
                    </div>
                </div>
            </div>
