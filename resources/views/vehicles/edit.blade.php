            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <div class="row">
                            <div class="col-6">
                                <h6 class="text-white text-capitalize ps-3">Edit Vehicle</h6>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" class="form-control @error('plate_number') is-invalid @enderror" 
                                           name="plate_number" value="{{ old('plate_number', $vehicle->plate_number) }}" required>
                                    @error('plate_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="number" class="form-control @error('year') is-invalid @enderror" 
                                           name="year" value="{{ old('year', $vehicle->year) }}" min="1900" max="{{ date('Y') + 1 }}" required>
                                    @error('year')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="number" class="form-control @error('tank_capacity') is-invalid @enderror" 
                                           name="tank_capacity" value="{{ old('tank_capacity', $vehicle->tank_capacity) }}" min="0" step="0.1" required>
                                    @error('tank_capacity')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="number" class="form-control @error('current_fuel_level') is-invalid @enderror" 
                                           name="current_fuel_level" value="{{ old('current_fuel_level', $vehicle->current_fuel_level) }}" min="0" max="100" step="1" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="material-symbols-rounded me-2">save</i>Update Vehicle
                                </button>
