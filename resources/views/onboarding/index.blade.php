            ...
            <div class="col-lg-10">
                <div class="onboarding-card">
                    ...
                    <div class="p-4">
                        <div id="stepContent">
                            @foreach($onboardingData['steps'] as $index => $step)
                            <div class="step-content {{ $index === 0 ? 'active' : 'd-none' }}" data-step="{{ $index + 1 }}">
                                <div class="text-center mb-4">
                                    <div class="icon-shape bg-gradient-{{ $step['color'] }} shadow-{{ $step['color'] }} rounded-circle mx-auto mb-3" style="width: 80px; height: 80px; display: flex; align-items: center; justify-content: center;">
                                        <i class="material-symbols-rounded text-white" style="font-size: 2rem;">{{ $step['icon'] }}</i>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 mb-3">
                                        <a href="{{ route($action['route']) }}" class="quick-action-btn card">
                                            <div class="card-body text-center">
                                                <i class="material-symbols-rounded text-primary mb-2" style="font-size: 2rem;">{{ $action['icon'] }}</i>
                            ...
                            <div class="card-body">
                                ...
                                <div class="help-resource-card p-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <i class="material-symbols-rounded text-info me-3" style="font-size: 1.5rem;">{{ $resource['icon'] }}</i>
                                        <div>
