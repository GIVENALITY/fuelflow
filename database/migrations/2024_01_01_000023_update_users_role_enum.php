...
return new class extends Migration
{
    ...
    {
        // First, update any existing users with invalid role values to existing valid roles
        DB::table('users')->where('role', 'fuel_pumper')->update(['role' => 'station_manager']);
        DB::table('users')->where('role', 'pumper')->update(['role' => 'station_manager']);
        DB::table('users')->where('role', 'attendant')->update(['role' => 'station_manager']);
